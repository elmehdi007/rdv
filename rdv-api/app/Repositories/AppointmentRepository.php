...
class AppointmentRepository extends BaseRepository {
     ...
     * @param City $model
     */
    public function __construct(\App\Models\Appointment $model, Request $request) {
    ...
    public function searching($columns = array('*'), $condition = [],&$count) {
        $rows = $this->model
                ->leftjoin("entreprises as client","client.id","appointments.id_client")
                ->leftjoin("entreprises as provider","provider.id","appointments.id_provider")
